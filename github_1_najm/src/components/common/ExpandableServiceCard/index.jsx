...
// Icon mapping - using icons that exist in react-icons/fi
const iconMap = {
    FiPlane: FiGlobe, // Using FiGlobe for flights (plane icon doesn't exist in fi)
    FiHome: FiHome,
    FiMap: FiMap,
...
const ExpandableServiceCard = ({ 
    ...
    const IconComponent = iconMap[icon] || FiGlobe;
