...
import { FiCheckCircle, FiAward, FiUsers, FiClock, FiChevronDown, FiGlobe, FiMapPin } from 'react-icons/fi';
    ...
    const additionalServices = [
        {
            ...
            detailedDescription: "نقدم خدمات الترجمة المعتمدة من وإلى جميع اللغات، مع ختم وتوقيع رسمي معتمد من وزارة الخارجية.",
            features: [
                "ترجمة الوثائق الرسمية",
                "ترجمة العقود والمستندات القانونية",
                "ترجمة الشهادات التعليمية",
                "تصديق وتوثيق الترجمة"
            ]
        },
        {
            title: "برامج الحج والعمرة",
            tagline: "رحلات روحانية بأعلى درجات الراحة",
            icon: <TbBuildingMosque />,
            category: "hajj",
            detailedDescription: "برامج متكاملة للحج والعمرة مع أفضل الخدمات والإرشادات الروحانية.",
            features: [
                "برامج متكاملة للحج والعمرة",
                "فنادق مميزة قريبة من الحرمين",
                "مرشدين شرعيين مرافقين",
                "نقل مريح وخدمات متكاملة"
            ]
        }
    ];

    // Combine services
    const services = [...allServices, ...additionalServices];
                ...
                <div className="container">
                    <div className="cta-box">
                        ...
                        <div className="cta-image">
                            <LazyImage src="/hero-bg.png" alt="رحلة مخصصة" />
